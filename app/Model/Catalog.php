...
class Catalog extends Model
{
    protected $fillable = [
        ...
        'url', 'user_id', 'active', 'phone_number', 'geo_location', 'logo_url'
    ];

    public function getClicks()
    {
        return $this->hasMany('App\Model\CatalogClick', 'catalog_id', 'id');
    }
    ...
    {
        return $this->belongsToMany('App\Model\CatalogCategory', 'catalog_category', 'catalog_id', 'category_id');
    }

    public function tags()
    {
        return $this->belongsToMany('App\Model\Tag', 'catalogs_tags', 'catalog_id', 'tag_id');
    }

@extends('admin_user.layouts.login')
                    ...
                    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                        <div class="content content-full">
                            ...
                            <div class="px-30 py-10">
                                <a class="link-effect font-w700" href="{{ Request::path() }}">
                            ...
                            <form class="js-validation-signin px-30" action="{{ route('admin.user.login') }}" method="post">
                                @csrf
                                <div class="form-group @if(session('error')) is-invalid @endif row">
                                    <div class="col-12">

...
<div id="page-container" class="sidebar-o @if(Cookie::get('dashboardColor') == 'black') sidebar-inverse @endif side-scroll">
    ...
    @include('admin_user.layouts.partials.aside')


    @include('admin_user.layouts.partials.sidebar')



    @include('admin_user.layouts.partials.header')
    ...
    <!-- END Main Container -->
    @include('admin_user.layouts.partials.footer')
</div>
<!-- END Page Container -->

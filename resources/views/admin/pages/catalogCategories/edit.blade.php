...
@section('content')
    ...
    @endif
    <form action="{{ route('catalogcategories.update', $category->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="block-content block-content-full tab-content">
                        ...
                        <div class="form-material floating">
                            <select class="form-control" id="material-select2" name="parent_id">
                                ...
                                @foreach($categories as $category_list)
                                    <option value="{{ $category_list->id }}" @if($category_list->id == $category->id) disabled @endif @if($category_list->id == $category->parent_id) selected @endif>{{ strip_tags($category_list->ru_title) }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="js-colorpicker input-group" style="width: max-content">
                                <input type="text" class="form-control" id="example-colorpicker2" name="color" value="{{ $category->color }}">

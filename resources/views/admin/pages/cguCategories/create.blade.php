...
@section('content')
    ...
    @endif
    <form action="{{ route('cgucategories.store') }}" method="post" enctype="multipart/form-data" id="disableThis">
        @csrf
        <div class="row">
            <div class="col-md-12">
                            ...
                            <select class="form-control" id="material-select2" name="parent_id">
                                ...
                                @foreach($categories as $category_list)
                                    ...
                                    @if($category_list->hasChildren())
                                        @include('admin.pages.cguCategories.components.categories', ['dilimiter' => '---', 'category' => $category_list])
                                    @endif
                                @endforeach
                            </select>

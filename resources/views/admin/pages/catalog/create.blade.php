...
@section('content')
    ...
    @endif
    <form action="{{ route('catalog.store') }}" method="post" enctype="multipart/form-data" id="disableThis">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="js-wizard-simple block">
                    ...
                    <!-- Form -->
                        ...
                        <div class="block-content block-content-full tab-content" style="min-height: 267px;">
                            ...
                            <div class="form-group">
                                <div class="form-material">
                                    <input type="text" class="form-control" id="wizard-simple2-lastname" name="url" value="{{ old('url') }}">

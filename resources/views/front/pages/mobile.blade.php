...
<head>
    ...
    <!-- END Icons -->
  	...
  	<link rel="stylesheet" href="{{ asset('assets/css/third_party.css?')}}ver=72">
</head>
	...
	<div class="mobile_main_bg">
		<div class="mobile_main_bg_white">
			<div class="mobile_main_header">
				...
				<div class="mobile_main_header_logo">
					<img src="/assets/img/various/hexagons.png" alt="">
					<div class="mobile_main_header_logo_text">
						<h1 class="mobile_main_header_logo_text_title">
							PublicService.uz
						</h1>
						<h1 class="mobile_main_header_logo_text_small">
							<span>ИНФОРМ ИНТЕРНЕТ ПОРТАЛ</span><br>
							INFORM EXPRESS INTERNET PORTAL
						</h1>
					</div>
				</div>
				<div class="mobile_main_header_inner">
					...
					<ul class="nav header_nav main_nav" style="display: none;">
		                ...
		                <li class="nav-item">
		                    <a class="nav-link active" href="{{route('home.categories2')}}"><h5 class="m-0">Express Info</h5></a>
		                </li>
		            </ul>
				</div>
			</div>
			<div class="mobile_main">
				<div class="mobile_main_top">
					<a href="{{route('home.categories2')}}" class="mobile_main_bottom_title">Express Info</a>
					<p class="mobile_main_top_text">Информационный портал</p>
				</div>
				<div class="mobile_main_inner">
					<div class="mobile_main_item mobile_main_item_gap">
						<div class="mobile_main_item_outer">
						  	...
						  	<div class="mobile_main_item_inner">
						  		<a href="{{route('home.categories2')}}" class="mobile_main_item_inner_link">
					...
					<div class="mobile_main_item mobile_main_item_center">
						<div class="mobile_main_item_inner">
							<img src="/uploads/center_icons.png" alt="" class="mobile_main_item_icon">
						</div>
					</div>
					<div class="mobile_main_item">
						<div class="mobile_main_item_outer">
							...
							<div class="mobile_main_item_inner">
								<a href="http://publicservice.uz/cgu_info/39" class="mobile_main_item_inner_link">
									<img src="/img/logo-gerb.png?ver=2" alt="" class="mobile_main_item_icon">
								</a>
							</div>
						</div>
					</div>
						...
						<div class="mobile_main_item_outer">
							...
							<div class="mobile_main_item_inner">
								<a href="http://advice.uz/" class="mobile_main_item_inner_link">
									<img src="/uploads/mobile_item_logo_5.png" alt="" class="mobile_main_item_icon">
								</a>
							</div>
						</div>
					</div>
						...
						<div class="mobile_main_item_outer">
							...
							<div class="mobile_main_item_inner">
								<a href="http://lex.uz/" class="mobile_main_item_inner_link">
									<img src="/uploads/mobile_item_logo_6.png" alt="" class="mobile_main_item_icon">
								</a>
							</div>
						</div>
					</div>
				</div>
				<div class="mobile_main_bottom">
					<a href="{{route('home.categories2')}}" class="mobile_main_top_title">Publicservice.uz</a>
		...
		<div class="mobile_main_links">
			<div class="mobile_main_links_inner">
				...
				<a href="{{ route('home.cgu.info') }}" class="mobile_main_links_inner_btn">
					Информация о ЦГУ
				</a>
				<a href="{{ route('home.cgu.ad') }}" class="mobile_main_links_inner_btn">
					Реклама в ЦГУ
				</a>
			</div>
		</div>

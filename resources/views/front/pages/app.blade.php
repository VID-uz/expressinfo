...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="{{ asset('assets/css/third_party.css') }}?ver=75">
    <!-- <link rel="stylesheet" href="http://express.vid.uz/css/steps.css"> -->
    <style>
        fadethis{
...
<div class="contacts_popup2" id="form_popup" style="@if($cooked) display: block; @else display: none; @endif z-index: 13;"></div>
...
<script src="http://express.vid.uz/assets/js/plugins/jquery-validation/jquery.validate.min.js"></script>
<script src="http://express.vid.uz/assets/js/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>
    <script src="http://express.vid.uz/assets/js/jquery.steps.min.js"></script>
	<script src="/js/jquery.fancybox.min.js"></script>
	<script src="/js/lazyload.js"></script>

<!-- Page JS Plugins -->
<script src="{{ asset('assets/js/plugins/chartjs/Chart.bundle.min.js') }}"></script>
<script src="{{ asset('assets/js/third_party.js') }}?ver=16"></script>
